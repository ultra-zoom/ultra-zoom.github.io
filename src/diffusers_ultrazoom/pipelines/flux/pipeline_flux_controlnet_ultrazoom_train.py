...
from diffusers_ultrazoom.loaders.lora_pipeline_ultrazoom import FluxLoraLoaderMixin
...
class FluxControlNetPipeline(DiffusionPipeline, FluxLoraLoaderMixin, FromSingleFileMixin):
    ...
    def __call__(
        ...
        if self.controlnet.__class__.__name__ == "FluxControlNetModel":
        ...
        elif self.controlnet.__class__.__name__ == "FluxMultiControlNetModel":
            control_images = []
            # xlab controlnet has a input_hint_block and instantx controlnet does not
